defmodule CatWeb.PostControllerTest do
  use CatWeb.ConnCase

  import Cat.PostsFixtures

  @create_attrs %{author: "some author", description: "some description", fetched_at: ~U[2022-10-18 22:22:00Z], link: "some link", pub_date: ~U[2022-10-18 22:22:00Z], title: "some title"}
